hdfs dfs -rm -r /user/$USER/assignment2/task3_1
hadoop jar /opt/hadoop/hadoop-2.7.3/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar \
	...
	-output /user/$USER/assignment2/task3_1 \
...
hdfs dfs -rm -r /user/$USER/assignment2/task3_2
hadoop jar /opt/hadoop/hadoop-2.7.3/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar \
	-D mapreduce.job.output.key.comparator.class=org.apache.hadoop.mapreduce.lib.partition.KeyFieldBasedComparator \
	-D mapred.reduce.tasks=1 \
	-input /user/$USER/assignment2/task3_1 \
	-output /user/$USER/assignment2/task3_2 \
    -mapper mapper2.py -file mapper2.py \
    -reducer reducer2.py -file reducer2.py \
	-partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner

hdfs dfs -cat /user/$USER/assignment2/task3_2/* > *.out
